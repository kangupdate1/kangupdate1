...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Repo", "https://www.github.com/kangupdate2/mirror-leech-telegram-bot")
    buttons.buildbutton("Owner", "https://www.github.com/kangupdate2")
    reply_markup = InlineKeyboardMarkup(buttons.build_menu(2))
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f'''
Bot mirror semua link ke Google Drive atau telegram!
...
def bot_help(update, context):
    button = ButtonMaker()
    button.buildbutton("Penggunaan", f"https://telegra.ph/{help}")
